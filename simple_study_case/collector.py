...
class Collector(mosaik_api.Simulator):
    ...
    def init(self, sid, step_size, print_results=True, save_h5=True, h5_storename='collectorstore', h5_panelname=None):
    ...
    def finalize(self):
        ...
        if self.save_h5:
            ...
            print(panel)
            print('Saved to store: {0}, panel: {1}'.format(self.h5_storename, self.h5_panelname))
            store[self.h5_panelname] = panel
            store.close()
